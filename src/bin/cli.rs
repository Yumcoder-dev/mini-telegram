use mini_telegram::{client, DEFAULT_PORT};
...
#[structopt(name = "mini-telegram-cli", version = env!("CARGO_PKG_VERSION"), author = env!("CARGO_PKG_AUTHORS"), about = "Issue MTProto commands")]
struct Cli {
...
async fn main() -> mini_telegram::Result<()> {
    // Enable logging
