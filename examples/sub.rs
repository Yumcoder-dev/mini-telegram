//! Subscribe to a telegram channel example.
//!
//! A simple client that connects to a mini-telegram server, subscribes to "foo" and "bar" channels
...
pub async fn main() -> Result<()> {
    // Open a connection to the mini-telegram address.
